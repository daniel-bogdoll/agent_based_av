...
public final class RunDrtOpenBerlinScenario {
	...
	public static void main(String[] args) throws CommandLine.ConfigurationException {
		...
		if ( args.length==0 ) {
			...
			//// ADJUSTMENTS BEGIN LK
			//Use this for SC1.1 scenario
			args = new String[] {"scenarios/berlin-v5.5-10pct/input/drt/berlin-drt-v5.5-10pct.config_SC1.1.xml"}  ;
			
			//Use this for SC1.2 scenario
			//args = new String[] {"scenarios/berlin-v5.5-10pct/input/drt/berlin-drt-v5.5-10pct.config_SC1.2.xml"}  ;
			
			//Use this for SC1.3 scenario
			//args = new String[] {"scenarios/berlin-v5.5-10pct/input/drt/berlin-drt-v5.5-10pct.config_SC1.3.xml"}  ;
			
			
			
			//Use this for SC2.1 scenario
			//args = new String[] {"scenarios/berlin-v5.5-10pct/input/drt/berlin-drt-v5.5-10pct.config_SC2.1.xml"}  ;
			
			//Use this for SC2.2 scenario
			//args = new String[] {"scenarios/berlin-v5.5-10pct/input/drt/berlin-drt-v5.5-10pct.config_SC2.2.xml"}  ;
			
			//Use this for SC2.3 scenario
			//args = new String[] {"scenarios/berlin-v5.5-10pct/input/drt/berlin-drt-v5.5-10pct.config_SC2.3.xml"}  ;
			
			
			//Use this for SC3.1 scenario
			//args = new String[] {"scenarios/berlin-v5.5-10pct/input/drt/berlin-drt-v5.5-10pct.config_SC3.1.xml"}  ;
			
			//Use this for SC3.2 scenario
			//args = new String[] {"scenarios/berlin-v5.5-10pct/input/drt/berlin-drt-v5.5-10pct.config_SC3.2.xml"}  ;
	...
	public static void addDRTmode(Scenario scenario, String drtNetworkMode, String drtServiceAreaShapeFile, double buffer) {
		...
		for (Link link : scenario.getNetwork().getLinks().values()) {
			...
			if (link.getAllowedModes().contains(TransportMode.car)) {
				...
				//// ADJUSTMENTS BEGIN LK
				// skip drt links as well as the drt network has already been set
				//// ADJUSTMENTS END LK
			}
		}
