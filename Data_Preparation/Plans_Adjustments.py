...
#If no forecast implemented, download plans file directly
if forecast == "SC1":
...
for j in range(3):
    ...
    # Change the directory to "/Input_Processed_10pct"
    os.chdir(directory_processed_10pct)

    #Extract .xml file from .xml.gz
    ...
    # Open the file with write permissions to adjust car plans that go through SAV ban zone
    with open(filename, 'w') as f:
        ...
        # Iterate through every person & leg and check whether there are car routes - adjust to drt plans
