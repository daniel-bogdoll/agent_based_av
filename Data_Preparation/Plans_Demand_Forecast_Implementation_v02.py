...
#scenario = "SC2_2050_Low"
scenario = "SC3_2050_High"
...
new_filename = f"Data_Preparation/Input_Processed/1pct/berlin-v5.5-1pct_{scenario}.plans.xml"
...
if scenario == "SC2_2050_Low":
    num_new_persons = int(len(persons) * 0.0043)
elif scenario == "SC3_2050_High":
    num_new_persons = int(len(persons) * 0.1714)
